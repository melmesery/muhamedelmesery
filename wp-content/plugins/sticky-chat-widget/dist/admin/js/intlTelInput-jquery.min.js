        ...
        q = function (a, b) {
            ...
            return g(a, [{
                ...
                key: "_f", value: function () {
                    ...
                    var a = this.d, b = a.allowDropdown, d = a.separateDialCode, e = a.showFlags, f = a.customContainer,
                    ...
                    var k = b || e || d;
                    if (k && (this.k = this._e2("div", {"class": "iti__flag-container"}, j)), j.appendChild(this.a), k && (this.selectedFlag = this._e2("div", c({"class": "iti__selected-flag"}, b && {
                        role: "combobox",
